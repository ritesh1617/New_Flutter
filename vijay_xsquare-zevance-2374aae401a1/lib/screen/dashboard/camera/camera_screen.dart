...
class CameraScreen extends StatefulWidget {
  dynamic argument;
  CameraScreen(this.argument, {Key? key}) : super(key: key);
  @override
...
class _CameraScreenState extends State<CameraScreen>
  ...
  void initState() {
    ...
    isPickupFile=widget.argument as bool;
                                        ...
                                        onTap: _isVideoCameraSelected
                                            ? () async {
                                                if (_isRecordingInProgress) {
                                                  ...
                                                  var data=FileData(CustomFileType.video, File(_videoFile!.path));
                                                  if(isPickupFile){
                                            ...
                                            : () async {
                                                ...
                                                var data=FileData(CustomFileType.photo, File(imageFile.path));
                                                if(isPickupFile){
                                                  navigatorKey.currentState!.pop(data);
                                                }else {
                                                  navigatorKey.currentState!
