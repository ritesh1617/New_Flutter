...
class CreateProfileScreen extends StatefulWidget {
  ...
  CreateProfileScreen(this.argument, {Key? key}) : super(key: key);
...
class _CreateProfileScreenState extends State<CreateProfileScreen>
  ...
  void initState() {
    super.initState();
    isBack=widget.argument as bool;
  ...
  void getData() async {
    ...
    if (data != null) {
      ...
      _firstNameController.text =
          (user!.userable!.firstName != null) ? user!.userable!.firstName! : "";
      _lastNameController.text =
          (user!.userable!.lastName != null) ? user!.userable!.lastName! : "";
